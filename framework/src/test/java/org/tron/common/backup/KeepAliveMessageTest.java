...
public class KeepAliveMessageTest {
  ...
  public void discardsUnknownFields() throws Exception {
    ...
    // Parsing routes through ProtoUtil.parseFrom, so the padded message still parses and its
    // known fields are intact while the unknown padding is discarded from the parsed proto.
